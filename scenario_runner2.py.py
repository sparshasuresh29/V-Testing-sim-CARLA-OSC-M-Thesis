...
CARLA_PATH = "/home/rm/Desktop/Carla"
# Find the .egg file dynamically and add it to sys.path
egg_path = glob.glob(os.path.join(CARLA_PATH, "PythonAPI/carla/dist/carla-0.9.14-py3.7-linux-x86_64.egg"))[0] 
